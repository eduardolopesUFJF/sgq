...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__check_box_layout_1__ = __webpack_require__(833);
...
var CheckBoxLayout1 = /** @class */ (function () {
    ...
    CheckBoxLayout1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'check-box-layout-1',template:/*ion-inline-start:"C:\Users\jluca\OneDrive\Documents\GitHub\sgq\App\sgq\src\core\check-box\layout-1\check-box.html"*/'<!--Themes Simple -->\n\n<ion-content>\n\n  <ion-grid no-padding *ngIf="data != null">\n\n    <ion-row>\n\n      <ion-col col-12>\n\n        <ion-list>\n\n          <!-- Header Title Top -->\n\n          <ion-list-header no-lines header-section>\n\n            <h1 header-title text-capitalize>{{data.title}}</h1>\n\n          </ion-list-header>\n\n          <ion-item default-item no-lines *ngFor="let item of data.items" (tap)="onEvent(\'onButton\', item)">\n\n            <!-- Content Title -->\n\n            <ion-label item-subtitle>{{item.title}}</ion-label>\n\n            <ion-checkbox [checked]="item.isChecked"></ion-checkbox>\n\n          </ion-item>\n\n        </ion-list>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\jluca\OneDrive\Documents\GitHub\sgq\App\sgq\src\core\check-box\layout-1\check-box.html"*/
        }),
