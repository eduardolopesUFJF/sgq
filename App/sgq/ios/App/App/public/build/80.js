...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__image_gallery_layout_2__ = __webpack_require__(817);
...
var ImageGalleryLayout2 = /** @class */ (function () {
    ...
    ImageGalleryLayout2 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'image-gallery-layout-2',template:/*ion-inline-start:"/Users/user227439/Desktop/sgq/App/sgq/src/core/image-gallery/layout-2/image-gallery-layout-2.html"*/'<!---Theme Gallery for Full gallery 2-->\n<ion-grid card-background-page no-padding *ngIf="data != null">\n    <ion-row>\n        <ion-col col-12 col-sm-4 col-md-6 col-lg-4 col-xl-3 *ngFor="let group of data.items;let i = index;">\n            <ion-card transparent (click)="openSubGallery(data, i)">\n              <img [src]="group.image" />\n                <ion-card-content>\n                    <h2 gallery-title text-wrap text-capitalize>{{group.title}}</h2>\n                    <p gallery-subtitle text-wrap>{{group.subtitle}}</p>\n                </ion-card-content>\n            </ion-card>\n        </ion-col>\n    </ion-row>\n</ion-grid>\n'/*ion-inline-end:"/Users/user227439/Desktop/sgq/App/sgq/src/core/image-gallery/layout-2/image-gallery-layout-2.html"*/
        }),
