...
var StorageServiceUtils = /** @class */ (function () {
    ...
    StorageServiceUtils = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__ionic_storage__["b" /* Storage */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__ionic_storage__["b" /* Storage */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__loading_service__["a" /* LoadingService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__loading_service__["a" /* LoadingService */]) === "function" && _b || Object])
    ], StorageServiceUtils);
...
var ToastService = /** @class */ (function () {
    ...
    ToastService = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0_ionic_angular__["t" /* ToastController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0_ionic_angular__["t" /* ToastController */]) === "function" && _a || Object])
    ], ToastService);
    return ToastService;
    var _a;
}());
...
var MyApp = /** @class */ (function () {
        ...
        this.storage.ready().then(function () {
            _this.storage.get('atualizacoes').then(function (atualizacoes) {
                if (atualizacoes) {
                    ...
                    _this.obterFornecedores();
                    _this.atualizacao = false;
                    _this.obterObras();
                    _this.obterPermissoesExclusao();
                }
            });
        });
    };
    ...
    MyApp.prototype.obterFornecedores = function () {
        var _this = this;
        this.fornecedorService.obterTodos().subscribe(function (data) {
            _this.storage.set('fornecedores', data);
        }, function (error) {
            _this.messageService.exibirMensagem("Falha na comunicação com o servidor ao buscar fornecedores, contate o suporte.");
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        usuarioSalvo = _a.sent();
                        this.permissaoService.obterPermissoesExclusao(usuarioSalvo).subscribe(function (data) {
                            _this.storage.set('permissoesExclusao', data);
                        }, function (error) {
                            _this.messageService.exibirMensagem("Falha na comunicação com o servidor ao buscar permissoes, contate o suporte.");
                        });
                        return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                ...
                this.alteracaoService.publicar(atualizacoes).subscribe(function (data) {
                    ...
                    if (_this.statusAtualizacao == "") {
                        ...
                        _this.messageService.exibirMensagem("Algumas atualizações não foram realizadas: " + _this.statusAtualizacao);
                        _this.statusAtualizacao = "";
                    }
    ...
    MyApp = MyApp_1 = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* Platform */],
            ...
            __WEBPACK_IMPORTED_MODULE_14__services_permissao_service__["a" /* PermissaoService */],
...
var FornecedorService = /** @class */ (function (_super) {
    __extends(FornecedorService, _super);
    function FornecedorService(http) {
        return _super.call(this, http, 'fornecedor/') || this;
    }
    FornecedorService.prototype.obterTodos = function () {
        this.headers = this.headers.set('BancoSchema', localStorage.getItem('BancoSchema'));
...
var PermissaoService = /** @class */ (function (_super) {
    __extends(PermissaoService, _super);
    function PermissaoService(http) {
        return _super.call(this, http, 'permissao/') || this;
    }
    PermissaoService.prototype.obterPermissoesExclusao = function (cliente) {
        this.headers = this.headers.set('BancoSchema', localStorage.getItem('BancoSchema'));
        return this.http.get(this.apiUrl + 'delecoes/' + cliente, { headers: this.headers })
            .catch(this.handleError);
    };
