...
var SelectLayout3 = /** @class */ (function () {
    ...
    SelectLayout3 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'select-layout-3',template:/*ion-inline-start:"/Users/user916661/Desktop/sgq/App/sgq/src/core/select/layout-3/select.html"*/'<ion-item color="secondary" no-lines *ngIf="data != null">\n    <ion-label>{{data.title}}</ion-label>\n    <ion-select [(ngModel)]="data.selectedItem" multiple="false" interface="action-sheet">\n        <ion-option *ngFor="let item of data.items; let i= index" [value]="item.id">{{item.title}}</ion-option>\n    </ion-select>\n</ion-item>\n'/*ion-inline-end:"/Users/user916661/Desktop/sgq/App/sgq/src/core/select/layout-3/select.html"*/
        }),
