...
<<<<<<< HEAD
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__range_layout_4__ = __webpack_require__(866);
=======
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__range_layout_4__ = __webpack_require__(838);
...
=======
            selector: 'range-button-layout-4',template:/*ion-inline-start:"/Users/duduulopes/Desktop/sgq/App/sgq/src/core/range/layout-4/range.html"*/'<!-- RANGE COMPONENTS - Two sliders -->\n<ion-list no-lines *ngIf="data != null">\n    <!--- Divider item-->\n    <ion-item-divider no-lines no-margin transparent>\n        <p ion-text color="primaryBase">{{data.title}}</p>\n    </ion-item-divider>\n    <ion-item transparent>\n        <ion-range dualKnobs="true" pin="true" [(ngModel)]="data.value" (ionChange)="onEvent(\'onChange\', data.value, $event)">\n            <ion-label range-left span-large color="primaryBase">{{data.textLeft}}</ion-label>\n            <ion-label range-right span-large color="primaryBase">{{data.textRight}}</ion-label>\n        </ion-range>\n    </ion-item>\n</ion-list>\n'/*ion-inline-end:"/Users/duduulopes/Desktop/sgq/App/sgq/src/core/range/layout-4/range.html"*/
>>>>>>> de8d8dcd1da236f3cd43d8a9e2e5ad6e84e68c99
        }),
