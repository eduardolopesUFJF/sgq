...
<<<<<<< HEAD
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__drag_and_drop_layout_3__ = __webpack_require__(841);
=======
...
=======
            selector: 'drag-and-drop-layout-3',template:/*ion-inline-start:"/Users/duduulopes/Desktop/sgq/App/sgq/src/core/list-view/drag-and-drop/layout-3/drag-and-drop.html"*/'<!-- Themes Drag and drop - Medium item with avatar-->\n<ion-content>\n  <ion-grid no-padding *ngIf="data != null">\n    <ion-row>\n      <ion-col col-12>\n        <!-- Header Medium item with avatar-->\n        <ion-list-header transparent header-section no-lines padding-horizontal>\n          <h1 header-title text-capitalize>{{data.header}}</h1>\n        </ion-list-header>\n        <!-- Content Medium Item With Avatar-->\n        <ion-list no-margin reorder="true" (ionItemReorder)="reorderItems($event)">\n          <ion-item no-lines default-item *ngFor="let item of data.items; let i = index;"\n          (click)="onEvent(\'onItemClick\', item.title, $event)">\n            <!--Avatar-->\n            <ion-thumbnail item-left>\n              <img [src]="item.image">\n            </ion-thumbnail>\n            <!--Title-->\n            <h2 item-title>{{item.title}}</h2>\n            <!--Subtitle-->\n            <h3 item-subtitle>{{item.subtitle}}</h3>\n          </ion-item>\n        </ion-list>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n'/*ion-inline-end:"/Users/duduulopes/Desktop/sgq/App/sgq/src/core/list-view/drag-and-drop/layout-3/drag-and-drop.html"*/
>>>>>>> de8d8dcd1da236f3cd43d8a9e2e5ad6e84e68c99
        }),
