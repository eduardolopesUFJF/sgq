...
var ItemAreaPage = /** @class */ (function () {
    ...
    ItemAreaPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-item-area',template:/*ion-inline-start:"/Users/user926185/Desktop/sgq/App/sgq/src/pages/item-area/item-area.html"*/'<ion-header>\n    <ion-navbar class="pad-nav-page-nt">\n        <ion-row>\n            <ion-col col-10 class="ptb-0">\n            </ion-col>\n            <ion-col col-2 class="ptb-0" (click)="voltarHome()">\n                <div buy>\n                    <ion-icon class="icon-menu home-icon" name="home"></ion-icon>\n                </div>\n            </ion-col>\n        </ion-row>\n    </ion-navbar>\n</ion-header>\n\n<appearance-animation-layout-5 class="margem-modal-ios" has-header [data]="area.servicos" [events]="events" [config]="config"></appearance-animation-layout-5>'/*ion-inline-end:"/Users/user926185/Desktop/sgq/App/sgq/src/pages/item-area/item-area.html"*/
        }),
