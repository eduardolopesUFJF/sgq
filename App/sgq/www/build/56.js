...
<<<<<<< HEAD
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__range_layout_2__ = __webpack_require__(864);
=======
...
=======
            selector: 'range-button-layout-2',template:/*ion-inline-start:"/Users/duduulopes/Desktop/sgq/App/sgq/src/core/range/layout-2/range.html"*/'<!-- RANGE COMPONENTS - With icons -->\n<ion-list no-lines *ngIf="data != null">\n   <!--- Divider item-->\n    <ion-item-divider no-lines no-margin transparent>\n      <p ion-text color="primaryBase">{{data.title}}</p>\n      <ion-badge item-end>{{data.value}}</ion-badge>\n    </ion-item-divider>\n    <ion-item transparent>\n        <ion-range [min]="data.min" [max]="data.max" pin="true" (ionChange)="onEvent(\'onChange\', data.value, $event)" [(ngModel)]="data.value">\n            <ion-icon range-left color="primaryBase" [name]="data.iconLeft"></ion-icon>\n            <ion-icon range-right color="primaryBase" [name]="data.iconRight"></ion-icon>\n        </ion-range>\n    </ion-item>\n</ion-list>\n'/*ion-inline-end:"/Users/duduulopes/Desktop/sgq/App/sgq/src/core/range/layout-2/range.html"*/
>>>>>>> de8d8dcd1da236f3cd43d8a9e2e5ad6e84e68c99
        }),
