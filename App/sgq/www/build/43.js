...
<<<<<<< HEAD
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__select_layout_6__ = __webpack_require__(875);
=======
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__select_layout_6__ = __webpack_require__(848);
>>>>>>> de8d8dcd1da236f3cd43d8a9e2e5ad6e84e68c99
...
=======
            selector: 'select-layout-6',template:/*ion-inline-start:"/Users/duduulopes/Desktop/sgq/App/sgq/src/core/select/layout-6/select.html"*/'<ion-item color="secondary" no-lines *ngIf="data != null">\n    <ion-label>{{data.title}}</ion-label>\n    <ion-select interface="popover" [(ngModel)]="data.selectedItemMonth" multiple="true">\n        <ion-option *ngFor="let item of data.itemsMonth; let i= index" [value]="item.id">{{item.title}}</ion-option>\n    </ion-select>\n\n    <ion-select interface="popover" [(ngModel)]="data.selectedItemYear" [multiple]="true">\n        <ion-option *ngFor="let item of data.itemsYears; let i= index" [value]="item.id">{{item.title}}</ion-option>\n    </ion-select>\n</ion-item>\n'/*ion-inline-end:"/Users/duduulopes/Desktop/sgq/App/sgq/src/core/select/layout-6/select.html"*/
>>>>>>> de8d8dcd1da236f3cd43d8a9e2e5ad6e84e68c99
        }),
