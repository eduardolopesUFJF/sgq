...
var SelectLayout2 = /** @class */ (function () {
    ...
    SelectLayout2 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'select-layout-2',template:/*ion-inline-start:"/Users/user926185/Desktop/sgq/App/sgq/src/core/select/layout-2/select.html"*/'<ion-item color="secondary" no-lines *ngIf="data != null">\n    <ion-label>{{data.title}}</ion-label>\n    <ion-select [(ngModel)]="data.selectedItem" multiple="false" interface="popover">\n        <ion-option *ngFor="let item of data.items; let i= index" [value]="item.id">{{item.title}}</ion-option>\n    </ion-select>\n</ion-item>\n'/*ion-inline-end:"/Users/user926185/Desktop/sgq/App/sgq/src/core/select/layout-2/select.html"*/
        }),
