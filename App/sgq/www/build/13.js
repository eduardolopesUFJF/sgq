...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_funcionario__ = __webpack_require__(923);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__models_item_inspecao__ = __webpack_require__(832);
                ...
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        if (this.exibirPorCentroCusto) {
                            this.funcionarios = __spreadArrays(this.funcionarios.filter(function (x) { return x.idCentroCusto == null || x.idCentroCusto == obra.idCentroCusto; }));
                        }
